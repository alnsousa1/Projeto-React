...
export const Carrinho = () => {
  ...
  const atualizarValorTotal = useCallback((carrinho: Array<ICarrinho>) => {
      let total = 0
          ...
          <tbody>
            {
              dataCarrinho.map((produto) => {
                ...
                return (
                  <TBTr key={produto.id}>
                    <Td><img src={'https://raw.githubusercontent.com/profchines/imagens1Pitchau/main/Imagens1Pitchau/' + produto.imagemp} alt="imagem" /></Td>
                    <Td width={300}>{produto.title}</Td>
